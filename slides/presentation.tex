...
\begin{frame}{SAT and its Extensions}
	...
	\begin{exampleblock}{2. Variable Addition}
		2012: Automated Reencoding of Boolean Formulas, Norbert Manthey, Marijn J.H. Heule and Armin Biere\\
		2023: Effective Auxiliary Variables via Structured Reencoding, Andrew Haberlandt, Harrison Green, Marijn J.H. Heule 
	\end{exampleblock}
...
\begin{frame}{Dependable Solving and Modern Hardware}
	...
	\end{exampleblock}
	\begin{exampleblock}{5. GPU-accelerated SAT Solving}
	...
	\end{exampleblock}
	\begin{exampleblock}{6. Parallel Model Counting}
...
\begin{frame}{Data Science and Applications}
	...
	\end{exampleblock}
	\begin{exampleblock}{7. Circuit Equivalence Checking}
		Bacchus et al. (2002): Enhancing Davis Putnam with Extended Binary Clause Reasoning\\
		Biere et al. (2024): Clausal Congruence Closure
	\end{exampleblock}
	...
	\end{exampleblock}
	\begin{exampleblock}{8. Formally Explainable AI (FXAI)}
